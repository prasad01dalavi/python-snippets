...
x1 = [1, 3, 6]  # First line chart Data
y1 = [4, 5, 2]

x2 = [2, 4, 5]  # Second line chart data
y2 = [7, 5, 9]

plt.plot(x1, y1, color='g', label="First Line Chart")
# Label is to specify legend

plt.plot(x2, y2, color='r', label="Second Line Chart")
# r = red colored line. Notice the syntax

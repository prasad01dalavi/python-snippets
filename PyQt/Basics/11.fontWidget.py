...
#--------------Progress Bar--------------------------------------------#
    ...
    def progressBarSetting(self):
        ...
        self.progress.setGeometry(250,90,250,20)    #dist from left,dist from up,length of the bar,height of the bar

        self.btn = QtGui.QPushButton('Download',self)
        self.btn.move (250,120)                     #dist from left, dist from up
...
#-------------------------Font Widget-------------------------------------------#
    def fontWidget(self):
        fontChoice = QtGui.QAction('Font',self)  #Name for the font menu is given as Font
